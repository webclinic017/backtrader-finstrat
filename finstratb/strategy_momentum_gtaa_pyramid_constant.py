""" This strategy uses the momentum logic from GTAA main, however uses pyramid technique for positioning

Pyramid is done using buying positions when fixed increments in asset value are happening.
"""
