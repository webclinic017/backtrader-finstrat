...
def run_cppi(risky_r, safe_r=None, m=3, start=1000, floor=0.8, riskfree_rate=0.03, periods_per_year=365, drawdown=None):
    """
    ...
    if safe_r is None:
        ...
        safe_r.values[:] = riskfree_rate/periods_per_year # fast way to set all values to a number
